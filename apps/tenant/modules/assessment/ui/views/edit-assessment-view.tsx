...
export const EditAssessmentView = ({ id }: EditAssessmentViewProps) => {
  const { data, isLoading } = useAssessmentById(id);
    ...
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="text-on-surface-variant/60 font-bold mt-2 max-w-xs">
          আপনি যে এসেসমেন্টটি এডিট করার চেষ্টা করছেন তা খুঁজে পাওয়া যায়নি অথবা আপনার এটি দেখার অনুমতি নেই।
        </p>
        <Link href="/holding-tax/assessments" className="mt-8">
  ...
  return (
    <AssessmentForm id={id} initialData={assessment as any} />
  );
};
