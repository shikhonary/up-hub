...
import { AssessmentForm } from "@/modules/assessment/ui/components/assessment-form";
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-sm leading-6 text-on-surface-variant max-w-lg font-bold opacity-70">
                নাগরিকের সঠিক খানা জরিপ ও হোল্ডিং তথ্যের ভিত্তিতে ট্যাক্স এসেসমেন্ট সম্পন্ন করুন। 
              </p>
            </div>
          </div>
