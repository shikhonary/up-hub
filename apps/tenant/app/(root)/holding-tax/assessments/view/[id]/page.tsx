...
import { ViewAssessmentView } from "@/modules/assessment/ui/views/view-assessment-view";
import { ChevronLeft } from "lucide-react";
import Link from "next/link";

export const metadata: Metadata = {
  title: "এসেসমেন্ট বিস্তারিত | UP-Hub",
  description: "ট্যাক্স এসেসমেন্ট ও খানা জরিপ তথ্যের বিস্তারিত বিবরণ দেখুন।",
};
      ...
      <main className="container mx-auto px-6 py-12 lg:px-12 max-w-7xl relative z-10">
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="w-8 h-8 rounded-full bg-white border border-outline/10 flex items-center justify-center hover:bg-primary hover:text-white transition-all shadow-sm">
