...
import { TradeLicenseApplicationForm } from "@/modules/trade-license-application/ui/components/trade-license-application-form";

export default function TradeLicenseApplyPage() {
  return (
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-sm leading-6 text-on-surface-variant max-w-lg font-bold opacity-70">
                ব্যবসায়িক প্রতিষ্ঠানের সঠিক তথ্য প্রদান করে ট্রেড লাইসেন্সের জন্য আবেদন করুন। সকল তথ্য নির্ভুলভাবে প্রদান করা আবশ্যক।
              </p>
            </div>
          </div>
